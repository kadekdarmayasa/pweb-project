...
<head>
    ...
    <link rel="stylesheet" href="../src/css/spp.css">
            ...
            <div class="isibar-title">
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <form action="">
                        ...
                        <div class="input">
                        <label for="TagihanSPP">Tagihan SPP</label>
                            <input type="text" placeholder="Tagihan SPP">
                        </div>
                        <div class="input">
                        <label for="TagihanOsis">Tagihan Osis</label>
                            <input type="text" placeholder="Tagihan Osis">
                        </div>
                    </form>
                    </div>
                    </div>
                ...
                <hr width="98%">
                    <div class="recordbar-box rb-fields">
                        ...
                        <div class="rb-5 rb-h1">
                            <h1><?= $row['tagihan_osis']?></h1>
                        </div>
                        <div class="rb-6 rb-h1">
                            <h1><?= $row['tagihan_spp']?></h1>
                        </div>
                    </div>
                <?php 
                endwhile;
