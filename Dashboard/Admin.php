...
<head>
    ...
    <title>Dashboard - Admin Kesiswaan</title>
...
<body>
    ...
    <div class="dash-2">
        <div class="menubar-dash2">
            <div class="menubar-left">
                <h1>Dashboard > Admin Kesiswaan</h1>
            </div>
        ...
        <div class="isibar">
            <div class="isibar-title">
                <div class="isibart-left">
                    <h1>Admin Kesiswaan</h1>
                </div>
                <!-- Button trigger modal -->
                <div class="isibar-right">
                    <button type="button" class="btn-create" data-bs-toggle="modal"
  ...
  $conn = mysqli_connect('localhost','kadekdarmayasa', 'darma2006', 'pendaftaran_siswa');
                ...
                $result = mysqli_query($conn, 'SELECT * FROM kesiswaan');
                if (!$result) {
                ...
                <hr width="98%">
                    <div class="recordbar-box rb-fields">
                        <div class="rb-1 rb-h1">
                            <h1><?= $row['nama_admin']?></h1>
                        </div>
                        <div class="rb-2 rb-h1">
                            <h1><?= $row['nip']?></h1>
                        </div>
                        <div class="rb-3 rb-h1">
                            <h1><?= $row['pendidikan']?></h1> 
                        </div>
